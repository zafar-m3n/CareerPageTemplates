...
const Benefits = () => {
  return (
    <section className="pt-12">
      <div className="flex justify-center mb-6 px-6 lg:px-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white px-6 lg:px-12 py-6 lg:py-12 items-center">
        <img
